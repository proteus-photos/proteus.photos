      ...
      <div className="flex flex-wrap -mx-4">
        <div className="w-full mt-16 px-4">
          ...
          <div className="flex flex-wrap">
            <a target="_blank" rel="noopener noreferrer" href="https://openreview.net/pdf?id=HrGa8Mq2NE" className="mb-4 text-xl py-2 px-6 bg-blue-500 text-white rounded hover:bg-blue-800 w-full sm:w-auto mr-4">Read ICML DinoHash Paper</a>
            <a target="_blank" rel="noopener noreferrer" href="https://arxiv.org/abs/2503.11195" className="mb-4 text-xl border border-blue-500 text-blue-500 py-2 px-6 rounded hover:bg-blue-800 w-full sm:w-auto mr-4">Read System Paper</a>
            <a target="_blank" rel="noopener noreferrer" href="https://proteusphotos.notion.site/Proteus-V2-Transformation-Resistant-AI-Image-Watermarking-2fae4336b9534e6ab4410003461a2811" className="mb-4 text-xl bg-white-500 text-green-500 border border-green-500 py-2 px-6 rounded hover:bg-green-800 w-full sm:w-auto mr-4">Read blog post</a>
